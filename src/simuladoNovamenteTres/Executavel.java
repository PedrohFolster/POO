...
public class Executavel {
    ...
    public static void main(String[] args) {
        ...
        Biblioteca biblioteca = new Biblioteca("Biblioteca Central", listaObras, enderecoBiblioteca);
        ...
        System.out.println();
        // 2 - Listar Obra mais Antiga
        biblioteca.listarObraMaisAntiga();

        System.out.println();
        // 3 - Autor mais novo
        biblioteca.listarAutorMaisNovo();
